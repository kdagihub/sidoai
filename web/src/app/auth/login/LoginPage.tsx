...
export default function LoginPage({
  ...
  return (
    <div className="flex flex-col w-full justify-center">
      ...
      {!hidePageRedirect && (
        <p className="text-center mt-4 text-text-03 text-sm">
          ...
          <span
            ...
            className="text-theme-primary-05 font-medium cursor-pointer hover:text-theme-primary-04 underline underline-offset-2"
          >
            Créer un compte
          </span>
        </p>
